...
\begin{document}
    ...
    \institution{Quantitative Portfolio Construction Strategy}[][\href{https://github.com/laurence1126/Quant-Trading-Strategy}{\githubIcon}]{01/24 - 04/24}
    \begin{itemize}
    ...
    \institution{Structured Products Pricing}[Equity-Linked Note][\href{https://github.com/laurence1126/Equity-Linked-Note-Pricer}{\githubIcon}]{09/23 - 12/23}
    \begin{itemize}
    ...
    % CuSell
    \institution{CuSell}[Online second-hand trading platform for CUHK students][\href{https://github.com/1155141394/CuSell}{\githubIcon}]{01/22 - 04/22}
    \begin{itemize}
