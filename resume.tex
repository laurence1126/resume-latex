...
\begin{document}
    ...
    \position{Master of Science in Computational Finance - MSCF}[QPA: 4.25 / 4.33]{12/25}
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \skills{Programming}{Python (OOP, data analysis \& visualization), LaTeX, R, Excel VBA, Linux Command}
